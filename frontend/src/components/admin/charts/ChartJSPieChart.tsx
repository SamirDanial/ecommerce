...
const ChartJSPieChart: React.FC<ChartJSPieChartProps> = ({ 
  ...
  const chartColors = validData.map((item, index) => 
    ...
    datasets: [
      {
        ...
        hoverBackgroundColor: chartColors.map(color => color.replace('0.6', '0.8')),
            ...
            if (data.labels && data.datasets) {
              return data.labels.map((label, index) => {
                ...
                return {
                  ...
                  fillStyle: Array.isArray(dataset.backgroundColor) ? dataset.backgroundColor[index] as string : dataset.backgroundColor as string,
                  strokeStyle: Array.isArray(dataset.borderColor) ? dataset.borderColor[index] as string : dataset.borderColor as string,
                  lineWidth: 2,
                  hidden: false,
                  index: index
                };
