...
const AdminLayout: React.FC = () => {
  ...
  const isOverlay = false; // Never use overlay mode - always push content
  const sidebarWidth = isCollapsed ? '4rem' : '20rem';
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-gray-50">
      {/* Sidebar */}
      {/* Sidebar - always in document flow, never overlay */}
      <div className={`bg-white shadow-xl transition-all duration-300 ease-in-out flex-shrink-0 ${sidebarWidthClass}`}>
