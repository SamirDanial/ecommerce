        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-base md:text-lg text-blue-100 mb-3 max-w-2xl mx-auto">
              Premium quality T-shirts with designs that speak your language. 
              Express yourself with comfort and style.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
            <div className="text-center group">
              <div className="bg-white/10 rounded-xl p-3 backdrop-blur-sm border border-white/20 group-hover:bg-white/20 transition-all duration-300">
                <Truck className="h-6 w-6 mx-auto mb-2 text-green-300" />
                <h3 className="text-sm font-semibold mb-1">Free Shipping</h3>
                <p className="text-blue-100 text-xs">On orders over $50</p>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="bg-white/10 rounded-xl p-3 backdrop-blur-sm border border-white/20 group-hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-blue-100 text-xs">30-day return policy</p>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="bg-white/10 rounded-xl p-3 backdrop-blur-sm border border-white/20 group-hover:bg-white/20 transition-all duration-300">
                ...
                <h3 className="text-base font-semibold mb-1">Premium Materials</h3>
                <p className="text-blue-100 text-xs">100% organic cotton</p>
              </div>
            </div>
          </div>
