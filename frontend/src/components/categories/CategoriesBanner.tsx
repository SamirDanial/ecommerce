        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-4">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mb-2 bg-gradient-to-r from-yellow-200 to-pink-200 bg-clip-text text-transparent">
              Find Your Perfect Style Category
            </h2>
            
            <p className="text-base md:text-lg text-blue-100 mb-3 max-w-2xl mx-auto">
              From casual wear to statement pieces, explore our carefully curated categories. 
              Each collection tells a unique story - find yours today!
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
            <div className="text-center group">
              <div className="bg-white/10 rounded-xl p-3 backdrop-blur-sm border border-white/20 group-hover:bg-white/20 transition-all duration-300">
                ...
                <h3 className="text-sm font-semibold mb-1">Curated Collections</h3>
                <p className="text-blue-100 text-xs">Handpicked for you</p>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="bg-white/10 rounded-xl p-3 backdrop-blur-sm border border-white/20 group-hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-blue-100 text-xs">100% satisfaction</p>
              </div>
            </div>
            ...
            <div className="text-center group">
              <div className="bg-white/10 rounded-xl p-3 backdrop-blur-sm border border-white/20 group-hover:bg-white/20 transition-all duration-300">
                ...
                <h3 className="text-sm font-semibold mb-1">Secure Shopping</h3>
                <p className="text-blue-100 text-xs">Safe & protected</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-blue-100 text-xs mt-2 opacity-80">
              Join thousands of fashion-forward customers worldwide
            </p>
          </div>
        </div>
      </div>
