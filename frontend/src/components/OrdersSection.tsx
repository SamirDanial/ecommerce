...
const OrdersSection: React.FC<OrdersSectionProps> = ({
  ...
  const { data: selectedOrder, isLoading: orderDetailsLoading } =
                ...
                >
                  ...
                  <div className="flex flex-col gap-3 sm:gap-4 mb-3 sm:mb-4">
                    ...
                    <div className="sm:hidden">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-2">
                        <div>
                          <div className="text-sm text-gray-500 mb-0.5 leading-tight">
                            Order Date
                          </div>
                  ...
                  <div className="flex items-center justify-between pt-0 sm:pt-4">
                    <div className="flex gap-4">
                      ...
                      <button
                        onClick={() =>
                          handleOpenTracking(order.id, order.orderNumber)
                        }
            ...
            <div className="space-y-4 sm:space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center py-2">
                    ...
                    <span className="font-medium">
                      {formatPriceWithCurrency(
                        toNumber(selectedOrder.subtotal),
                  ...
                  <div className="flex justify-between items-center py-2">
                    ...
                    <span className="font-medium">
                      {formatPriceWithCurrency(
                        toNumber(selectedOrder.shipping),
                        selectedOrder.currency
                      )}
                    </span>
                  </div>
                  ...
                  {toNumber(selectedOrder.discount) > 0 && (
                    <div className="flex justify-between items-center py-2 bg-green-50 p-3 rounded-lg">
                      ...
                      <span className="text-green-700 font-bold">
                        -
                        {formatPriceWithCurrency(
                          toNumber(selectedOrder.discount),
                          selectedOrder.currency
                        )}
                      </span>
                    </div>
              ...
              <div className="border border-gray-200 rounded-lg p-3 sm:p-6">
                ...
                <div className="grid grid-cols-1 gap-4 sm:gap-6">
                  {/* Contact Details */}
                  <div>
                    <h4 className="font-medium text-gray-800 mb-3 text-base sm:text-lg">
                      Contact Details
                    </h4>
