...
const Home: React.FC = () => {
  ...
  const [trendingViewMode, setTrendingViewMode] = useState<"grid" | "list">(
    getDefaultViewMode
  );
  const [categoriesViewMode, setCategoriesViewMode] = useState<"grid" | "list">(
    getDefaultViewMode
  );
  const [featuredViewMode, setFeaturedViewMode] = useState<"grid" | "list">(
    getDefaultViewMode
  );
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [productsData, categoriesData, flashSalesData] =
          await Promise.all([
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 relative overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        {/* Heart Icon Hider - Covers any heart icon in top right */}
        <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-r from-blue-900 to-purple-900 z-30 pointer-events-none rounded-bl-2xl"></div>

        {/* Additional click blocker to prevent any wishlist functionality in top right */}
        <div
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-lg sm:text-xl md:text-2xl mb-8 opacity-90 max-w-2xl lg:max-w-none animate-fade-in-up animation-delay-400 text-white">
                  Discover our premium collection of comfortable, stylish, and
                  high-quality t-shirts designed for every occasion and
                  personality
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in-up animation-delay-600">
                  <Button
                    asChild
                    size="lg"
                    className="text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 hover:scale-105"
                  >
                    <Link to="/products">
                      Shop Collection
                  ...
                  <Button
                    variant="outline"
                    size="lg"
                    className="text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 bg-white/10 border-white/20 text-white hover:bg-white/20 backdrop-blur-sm transition-all duration-300 hover:scale-105"
                  >
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="text-center">
              <Button
                asChild
                size="lg"
                className="bg-white text-red-600 hover:bg-gray-100 text-lg px-8 py-4 rounded-2xl font-bold shadow-2xl hover:shadow-white/25 transition-all duration-300 hover:scale-105"
              >
                <Link to="/products">
                  Shop Flash Sale
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Discover the most popular styles that everyone is talking about
            </p>
          </div>
          ...
          >
            {trendingProducts.map((product) => (
              <Card
                key={product.id}
                className={`group overflow-hidden transition-all duration-500 hover:shadow-2xl relative ${
                  trendingViewMode === "grid"
                  ...
                  {trendingViewMode === "grid" ? (
                    <>
                      ...
                      <CardHeader className="pb-4">
                        <CardTitle className="text-xl font-bold group-hover:text-blue-600 transition-colors duration-300 line-clamp-2">
                          {product.name}
                        </CardTitle>
                        <RatingDisplay
                    ...
                    <div className="flex w-full p-6">
                      <div className="relative w-40 h-48 flex-shrink-0 overflow-hidden rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                        <ImageWithPlaceholder
                          src={getImageUrl(product)}
                          alt={product.name}
                          className="w-auto h-auto max-w-full max-h-[200px] object-contain object-center group-hover:scale-110 transition-transform duration-500"
                      ...
                      <div className="flex-1 ml-6 flex flex-col justify-between">
                        <div>
                          <CardTitle className="text-xl font-bold group-hover:text-blue-600 transition-colors duration-300 line-clamp-2 mb-3">
                            {product.name}
                          </CardTitle>
                          <RatingDisplay
                            rating={product.averageRating}
          ...
          <div className="text-center mt-12">
            <Button
              asChild
              size="lg"
              className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-4 rounded-2xl font-bold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
              <Link to="/products">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Our most popular and highest-rated products, carefully selected
                    ...
                    <div className="flex w-full p-6">
                      <div className="relative w-40 h-48 flex-shrink-0 overflow-hidden rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                        <ImageWithPlaceholder
                          ...
                          alt={product.name}
                          className="w-auto h-auto max-w-full max-h-[200px] object-contain object-center group-hover:scale-110 transition-transform duration-500"
                          placeholderClassName="w-auto h-auto max-w-full max-h-full"
                        />
                        {product.isOnSale && (
                          <Badge className="absolute top-2 left-2 bg-gradient-to-r from-red-500 to-pink-500 text-white border-0 text-xs">
                            SALE
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center group">
                <div
                  className={`w-20 h-20 bg-gradient-to-r ${feature.color} rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg group-hover:shadow-xl`}
                >
