    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-1 sm:p-3 md:p-6">
      <div className="w-full space-y-3 sm:space-y-6 md:space-y-8">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm sm:text-base font-medium">Manage customer questions and provide answers</p>
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4 md:gap-6">
          ...
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-xl blur-xl group-hover:blur-lg transition-all duration-500"></div>
            <div className="relative bg-white/80 backdrop-blur-xl rounded-xl p-4 sm:p-6 border border-white/40 shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center">
                <div className="p-2 sm:p-3 bg-gradient-to-br from-blue-400 to-cyan-500 rounded-lg shadow-lg">
                  <MessageSquare className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                </div>
                <div className="ml-3 sm:ml-4">
                  <p className="text-xs sm:text-sm font-medium text-slate-600">Answered</p>
                  <p className="text-lg sm:text-xl md:text-2xl font-bold text-slate-900">{stats.answered}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="relative group">
          ...
          <div className="relative bg-white/80 backdrop-blur-xl rounded-xl border border-white/40 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
            <div className="p-4 sm:p-6 border-b border-white/30">
              <h2 className="text-lg sm:text-xl font-semibold text-slate-900">Questions</h2>
            </div>
              ...
              {loading ? (
                ...
                <div className="space-y-4">
                  ...
                  {!hasMore && questions.length > 0 && (
                    <div className="text-center py-8">
                      <p className="text-slate-500">No more questions to load</p>
                    </div>
                  )}
                </div>
              )}
