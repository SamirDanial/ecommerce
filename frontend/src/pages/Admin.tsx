  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Manage your e-commerce platform from here</p>
      </div>
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-gray-600">Product "Sample Product" updated</span>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-gray-600">Inventory low alert for "Product X"</span>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-center space-x-3">
              <div className="w-3 h-3 bg-green-500 rounded-full"></div>
              <span className="text-sm text-gray-700">Storage: Normal</span>
            </div>
          </div>
        </div>
      </div>
