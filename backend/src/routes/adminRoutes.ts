...
// ===== ORDER ROUTES MOVED TO adminOrderRoutes.ts =====
// All order-related routes are now consolidated in adminOrderRoutes.ts
// This prevents route conflicts and improves organization

// Update order status (admin function) - REMOVED: Duplicate route, now handled in adminOrderRoutes
